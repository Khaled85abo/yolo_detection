...
#define LV_USE_ASSERT_STR 0    /* Check is the string is valid. (Very fast, recommended) */
#define LV_USE_ASSERT_OBJ 0    /* Check if the object is valid. (Slow) */
#define LV_USE_ASSERT_MALLOC 0 /* Check if the memory is allocated with lv_mem_alloc. (Slow) */
 ...
 * LV_ATTRIBUTE_MEM_ALIGN_SIZE should be used to specify required alignment. */
...
/* 1: bitmap cache use the sbit cache, 0:no bitmap cache */
#define LV_FREETYPE_SBIT_CACHE 0
/* 0: no cache, 1: LRU cache, 2:Adaptive cache */
...
/*1: Enable lv_obj_refreash_size_from_style() */
#define LV_ENABLE_REFR_SIZE_FROM_STYLE 0
