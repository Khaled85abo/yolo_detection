...
output_path = 'videos_output/output_ori_2.mp4'
...
def process_frame(frame, model, tracker):
    ...
    for track in tracked_objects:
        ...
        if roi_x_start <= center_x <= roi_x_end:
            ...
            # Update memory only if we get a valid orientation in ROI
        ...
        # Use remembered orientation if available, otherwise use "unknown"
